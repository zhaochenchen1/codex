...
SKILL_NAME = "hithink-management-query"
SKILL_VERSION = "1.0.0"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="问财公司股东股本 - 股东股本数据查询工具",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=f"""
使用示例:
  python3 scripts/cli.py --query "同花顺股本结构"
  python3 scripts/cli.py --query "前十大股东"
  python3 scripts/cli.py --query "实控人信息" --page "2" --limit "20"
  python3 scripts/cli.py --query "股东户数" --api-key "your-key"
